# Disclaimer & Acceptable Use — batchim

`batchim` is part of the [gptaku-plugins](https://github.com/fivetaku/gptaku_plugins)
...
`batchim` is a general-purpose developer tool. Like most general-purpose tools, it
